...
INSTALLED_APPS = [
    ...
    # my_apps
    # we are installing hotel and hotel.booking function.
    'hotel',
    'hotel.booking_functions',

    # added from django all auth
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'CDTdjango@gmail.com'
EMAIL_HOST_PASSWORD = 'Check12345'
EMAIL_USE_TLS = True
...
# ACCOUNT_EMAIL_CONFIRMATION_ANONYMOUS_REDIRECT_URL = '/accounts/login/'
# ACCOUNT_EMAIL_CONFIRMATION_AUTHENTICATED_REDIRECT_URL = '/booking_list'
